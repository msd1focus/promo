...
public class PaAddRegionBackingBean implements Serializable {
    ...
    private final String SELECTED_REGION_ITERATOR =
        "PropRegionView1Iterator";
    private final String ALL_REGION_ITERATOR = "AllProposalRegionShuttleView1Iterator";
    
    public PaAddRegionBackingBean() {
        super();
    }
