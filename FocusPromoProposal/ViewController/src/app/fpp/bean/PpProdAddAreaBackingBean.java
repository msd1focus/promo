...
public class PpProdAddAreaBackingBean implements Serializable {
    ...
    private final String SELECTED_AREA_ITERATOR =
        "ProdRegionAreaView1Iterator";
    private final String ALL_AREA_ITERATOR = "AllProdukAreaShuttleView1Iterator";
    
    public PpProdAddAreaBackingBean() {
        super();
    }
