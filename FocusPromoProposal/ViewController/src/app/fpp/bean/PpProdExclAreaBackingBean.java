...
public class PpProdExclAreaBackingBean implements Serializable {
    ...
    private final String SELECTED_AREA_ITERATOR =
        "ExclCustAreaView1Iterator";
    private final String ALL_AREA_ITERATOR = "AllExcludeProdAreaShuttleView1Iterator";
    
    public PpProdExclAreaBackingBean() {
        super();
    }
