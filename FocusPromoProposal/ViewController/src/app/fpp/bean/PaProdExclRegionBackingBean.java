...
public class PaProdExclRegionBackingBean implements Serializable {
    ...
    private final String SELECTED_REGION_ITERATOR =
        "ExclCustRegionView1Iterator";
    private final String ALL_REGION_ITERATOR = "AllExcludeProdRegionShuttleView1Iterator";
    
    public PaProdExclRegionBackingBean() {
        super();
    }
    ...
    public List getSelectedRegions() {
        ...
        if (selectedRegions == null || refreshSelectedList) {
            selectedRegions =
                    attributeListForIterator(SELECTED_REGION_ITERATOR, "Region");
        }
