...
public class PpExclLocationBackingBean implements Serializable {
    ...
    private final String SELECTED_LOC_ITERATOR =
        "ExclPropCustLocView1Iterator";
    private final String ALL_LOC_ITERATOR = "AllExclProposalLocationShuttleView1Iterator";
    
    public PpExclLocationBackingBean() {
        super();
    }
