...
public class PaProdExclLocationBackingBean implements Serializable {
    ...
    private final String SELECTED_LOC_ITERATOR =
        "ExclCustLocView1Iterator";
    private final String ALL_LOC_ITERATOR = "AllExcludeProdLocationShuttleView1Iterator";
    
    public PaProdExclLocationBackingBean() {
        super();
    }
