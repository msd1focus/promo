...
public class PpProdAddCustGroupBackingBean implements Serializable {
    ...
    private final String SELECTED_CUST_GROUP_ITERATOR =
        "ProdRegionCustGroupView1Iterator";
    private final String ALL_CUST_GROUP_ITERATOR = "AllProdukCustGroupShuttleView1Iterator";
    
    public PpProdAddCustGroupBackingBean() {
        super();
    }
