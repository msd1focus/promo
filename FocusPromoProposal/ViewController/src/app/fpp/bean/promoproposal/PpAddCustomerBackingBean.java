...
public class PpAddCustomerBackingBean implements Serializable {
    ...
    private final String SELECTED_CUSTOMER_ITERATOR =
        "PropRegionCustomerView1Iterator";
    private final String ALL_CUSTOMER_ITERATOR = "AllProposalCustomerShuttleView1Iterator";
    
    public PpAddCustomerBackingBean() {
        super();
    }
        ...
        if (this.getSelectedCustomers().size() > 0) {
            for (int i = 0; i < getSelectedCustomers().size(); i++) {
                ...
                for(Row r : iterAllCust.getAllRowsInRange()){
                    ...
                    row.setAttribute("Custdescription", r.getAttribute("CustomerFullName"));  
                }
            }
