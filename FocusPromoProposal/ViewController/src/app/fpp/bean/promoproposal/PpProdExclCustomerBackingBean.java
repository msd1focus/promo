...
public class PpProdExclCustomerBackingBean implements Serializable {
    ...
    private final String SELECTED_CUSTOMER_ITERATOR =
        "ExclCustCustView1Iterator";
    private final String ALL_CUSTOMER_ITERATOR = "AllExcludeProdCustomerShuttleView1Iterator";
    
    public PpProdExclCustomerBackingBean() {
        super();
    }
