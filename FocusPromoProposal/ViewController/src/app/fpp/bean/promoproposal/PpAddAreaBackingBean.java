...
public class PpAddAreaBackingBean implements Serializable {
    ...
    private final String SELECTED_AREA_ITERATOR =
        "PropRegionAreaView1Iterator";
    private final String ALL_AREA_ITERATOR = "AllProposalAreaShuttleView1Iterator";
    
    public PpAddAreaBackingBean() {
        super();
    }
        ...
        if (this.getSelectedAreas().size() > 0) {
            for (int i = 0; i < getSelectedAreas().size(); i++) {
                ...
                for(Row r : iterAllCust.getAllRowsInRange()){
                    ...
                    row.setAttribute("Areadiscription", r.getAttribute("AreaLabel"));
                }
            }
