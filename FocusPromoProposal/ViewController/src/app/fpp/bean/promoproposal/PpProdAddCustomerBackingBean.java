...
public class PpProdAddCustomerBackingBean implements Serializable {
    ...
    private final String SELECTED_CUSTOMER_ITERATOR =
        "ProdRegionCustomerView1Iterator";
    private final String ALL_CUSTOMER_ITERATOR = "AllProdukCustomerShuttleView1Iterator";
    
    public PpProdAddCustomerBackingBean() {
        super();
    }
