...
public class PpProdAddRegionBackingBean implements Serializable {
    ...
    private final String SELECTED_REGION_ITERATOR =
        "ProdRegionView1Iterator";
    private final String ALL_REGION_ITERATOR = "AllProdukRegionShuttleView1Iterator";
    
    public PpProdAddRegionBackingBean() {
        super();
    }
